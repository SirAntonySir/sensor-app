...
struct ExerciseUnit: Identifiable {
    ...
    static let allUnits: [ExerciseUnit] = [
        ExerciseUnit(id: 1, name: "Unit 1", exercises: ["MIE", "4-0-4", "Tissue"], completions: 0, isUnlocked: true),
        ...
        ExerciseUnit(id: 4, name: "Unit 4", exercises: ["4-2-5", "Boat", "Candle"], completions: 0, isUnlocked: false),
        ExerciseUnit(id: 5, name: "Unit 5", exercises: ["4-7-11", "Tissue", "Windmill"], completions: 0, isUnlocked: false),
        ...
        ExerciseUnit(id: 8, name: "Unit 8", exercises: ["4-7-11", "Boat", "Candle"], completions: 0, isUnlocked: false),
